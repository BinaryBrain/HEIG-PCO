...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ThreadManager_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ThreadManager_t qt_meta_stringdata_ThreadManager = {
    {
QT_MOC_LITERAL(0, 0, 13), // "ThreadManager"
QT_MOC_LITERAL(1, 14, 24), // "incrementPercentComputed"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 15), // "percentComputed"
QT_MOC_LITERAL(4, 56, 10), // "exitThread"
QT_MOC_LITERAL(5, 67, 28), // "incrementProgressBarTransmit"
QT_MOC_LITERAL(6, 96, 13), // "passwordFound"
QT_MOC_LITERAL(7, 110, 8) // "password"

    },
    "ThreadManager\0incrementPercentComputed\0"
    "\0percentComputed\0exitThread\0"
    "incrementProgressBarTransmit\0passwordFound\0"
    "password"
};
...
void ThreadManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->incrementPercentComputed((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->exitThread(); break;
        case 2: _t->incrementProgressBarTransmit((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 3: _t->passwordFound((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ThreadManager::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadManager::incrementPercentComputed)) {
                *result = 0;
            }
        }
        {
            typedef void (ThreadManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadManager::exitThread)) {
                *result = 1;
            }
        }
    }
...
void *ThreadManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThreadManager.stringdata))
...
// SIGNAL 0
void ThreadManager::incrementPercentComputed(double _t1)
{
